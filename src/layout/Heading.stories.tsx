...
export const H2Stories: Story = {
  ...
  render: () => (
    <div className="space-y-8">
      ...
      <div>
        <Heading.H2 className="border-border border-b pb-2">H2 with Bottom Border</Heading.H2>
        <p className="text-muted-foreground mt-4">Add visual separation with a bottom border.</p>
      </div>
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-4">Add visual interest with accent elements.</p>
      </div>
    </div>
  ),
}
...
export const H3Stories: Story = {
  ...
  render: () => (
    <div className="space-y-6">
      ...
      <div>
        <Heading.H3 className="text-muted-foreground">Muted H3 Heading</Heading.H3>
        <p className="text-muted-foreground mt-2">Sometimes a more subdued heading works better.</p>
      </div>

      <div>
        <Heading.H3 className="text-muted-foreground text-sm font-bold tracking-wider uppercase">
          Small Caps H3
        </Heading.H3>
        <p className="text-muted-foreground mt-2">
...
export const ResponsiveDemo: Story = {
    ...
    <div className="space-y-8">
      <div className="bg-muted/30 rounded-lg p-6">
        ...
        <div className="text-muted-foreground mt-6 space-y-1 text-sm">
          <p>
            <strong>H1:</strong> text-3xl md:text-4xl lg:text-5xl
          </p>
          <p>
            <strong>H2:</strong> text-2xl md:text-3xl lg:text-4xl
          </p>
          <p>
            <strong>H3:</strong> text-xl md:text-2xl lg:text-3xl
          </p>
        </div>
      </div>
    </div>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'All heading components are responsive by default, scaling appropriately across different screen sizes.',
      },
    },
  },
}
    ...
    <article className="max-w-3xl space-y-6">
      <header className="space-y-4">
        ...
        <p className="text-muted-foreground text-lg">
          Learn how to create beautiful and readable typography hierarchies for your web projects
          with these essential principles and techniques.
        </p>
      ...
      <div className="space-y-8">
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            Typography hierarchy is the visual arrangement of text that helps readers navigate
            content effectively. It guides the eye and creates a clear information structure.
          </p>

          <div className="space-y-4">
            <Heading.H3>The Fundamentals</Heading.H3>
            <p className="text-muted-foreground">
              Good typography hierarchy relies on several key principles including size, weight,
              spacing, and color contrast.
            </p>

            <Heading.H4>Size and Scale</Heading.H4>
            <p className="text-muted-foreground">
              Use consistent scaling ratios to create harmonious size relationships between
              different heading levels.
            </p>

            <Heading.H5>Weight and Emphasis</Heading.H5>
            <p className="text-muted-foreground">
              Font weight helps establish importance and visual hierarchy within your content
              structure.
            </p>

            <Heading.H6>Color and Contrast</Heading.H6>
            <p className="text-muted-foreground">
              Strategic use of color and contrast can enhance readability and guide user attention
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            Following these guidelines will help you create effective typography hierarchies that
            improve user experience and content accessibility.
          </p>

          <Heading.H3>Consistency is Key</Heading.H3>
          <p className="text-muted-foreground">
            Maintain consistent styling patterns throughout your design system to create a cohesive
            user experience.
          </p>
        </section>
      </div>
  ...
  render: () => (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
      <div className="border-border rounded-lg border p-6">
        ...
        <p className="text-muted-foreground mb-4 text-sm">
          This card demonstrates how H4 headings work well for card titles and component headings.
        </p>
      ...
      <div className="border-border rounded-lg border p-6">
        ...
        <p className="text-muted-foreground mb-4 text-sm">
          H5 headings are perfect for smaller cards or when you need more subtle hierarchy.
        </p>
        <button className="bg-primary text-primary-foreground rounded px-3 py-1 text-sm">
          View Details
        </button>
      ...
      <div className="border-border rounded-lg border p-6">
        ...
        <p className="text-muted-foreground mb-4 text-sm">
          H6 headings work well for compact layouts and secondary information hierarchies.
        </p>
        <button className="bg-primary text-primary-foreground rounded px-3 py-1 text-sm">
          Read More
        </button>
...
export const CustomStyling: Story = {
  ...
  render: () => (
    <div className="space-y-8">
      <div>
        <Heading.H1 className="font-light tracking-tight">Light Weight H1</Heading.H1>
        <p className="text-muted-foreground mt-2">
      ...
      <div>
        <Heading.H2 className="font-black tracking-widest uppercase">Bold Uppercase H2</Heading.H2>
        <p className="text-muted-foreground mt-2">
      ...
      <div>
        <Heading.H3 className="border-primary border-l-4 pl-4 text-center italic">
      ...
      <div>
        <Heading.H4 className="relative inline-block">
          ...
          <span className="absolute inset-x-0 bottom-1 -z-10 h-3 bg-yellow-200"></span>
        </Heading.H4>
        <p className="text-muted-foreground mt-2">
