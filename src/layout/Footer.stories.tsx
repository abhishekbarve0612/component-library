...
export const Default: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    // Check that the footer has proper semantic markup
    const footer = canvas.getByRole('contentinfo')
    await expect(footer).toBeInTheDocument()
    
    // Check for copyright text
    const copyright = canvas.getByText(/© 2024 Company Name/i)
  ...
  render: (args) => (
    <Footer {...args}>
      <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        ...
        <nav className="flex items-center space-x-6">
          <a href="#" className="opacity-90 hover:opacity-100">About</a>
          <a href="#" className="opacity-90 hover:opacity-100">Contact</a>
          <a href="#" className="opacity-90 hover:opacity-100">Support</a>
        </nav>
      </div>
    </Footer>
  ),
    ...
    <Footer size="lg">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          />
          <button className="bg-primary text-primary-foreground px-6 py-2 rounded-md hover:bg-primary/90 whitespace-nowrap">
            Subscribe
          </button>
        </div>
      </div>
  ...
  render: () => (
    <Footer size="lg">
      <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li><a href="#" className="hover:text-foreground">Features</a></li>
            <li><a href="#" className="hover:text-foreground">Pricing</a></li>
            <li><a href="#" className="hover:text-foreground">Reviews</a></li>
      ...
      <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        ...
        <div className="flex items-center space-x-4">
          <select className="text-sm text-muted-foreground bg-transparent border border-border rounded px-2 py-1">
